...
package commands
{
	...
	public class CompositeCommandSortByIdTest extends AsynchronousTestCase
	{
		...
		*                              Public methods                              *
		***************************************************************************/
		public function CompositeCommandSortByIdTest(methodName:String=null)
		{
			super(methodName);
		}
		...
		{
			assertTrue('sorting of composite command by use of ids was not successful', m_success);
		}
